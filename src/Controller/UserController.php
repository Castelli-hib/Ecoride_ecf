...
final class UserController extends AbstractController
{
    ...
    {
        return $this->render('page/user/index.html.twig', [
    ...
    {
        return $this->render('page/user/profile_user.html.twig', [
    ...
    {
        return $this->render('page/user/historical.html.twig', [
    ...
    {
        return $this->render('page/user/reservation.html.twig', [
    ...
    {
        return $this->render('page/user/route_creation.html.twig', [
