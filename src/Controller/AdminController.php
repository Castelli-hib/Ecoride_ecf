...
final class AdminController extends AbstractController
{
    ...
    {
        return $this->render('page/admin/connection.html.twig', [
    ...
    {
        return $this->render('page/admin/admin_users.html.twig', [
    ...
    {
        return $this->render('page/admin/admin_routes.html.twig', [
    ...
    {
        return $this->render('page/admin/admin_reservations.html.twig', [
